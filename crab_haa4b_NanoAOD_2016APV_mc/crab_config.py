...
config.JobType.psetName = 'Nano_Hto4bPlus_2016APVMC_cfg.py' 
...
config.Data.outLFNDirBase = '/store/group/phys_susy/HToaaTo4b/NanoAOD/2016APV/MC/PNet_v2_2024_11_22/'
