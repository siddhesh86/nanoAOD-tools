...
#in_files = ['/store/data/Run2016B/JetHT/MINIAOD/ver1_HIPM_UL2016_MiniAODv2-v2/140000/0E60AAD9-2F63-9B4E-B241-48CE868CD8D1.root']

# Input source
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring(in_files[0]),
    fileNames = cms.untracked.vstring('file:/eos/cms/store/data/Run2016E/BTagCSV/MINIAOD/HIPM_UL2016_MiniAODv2-v1/280000/34FC13AB-4336-8F4A-9783-925C74750849.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '106X_dataRun2_v37', '') # https://twiki.cern.ch/twiki/bin/view/CMS/PdmVRun2LegacyAnalysis?rev=52
